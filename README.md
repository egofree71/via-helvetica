...
miss stops immediately, while envelopes that no longer save cells return to the
legacy radius-1/radius-2 workflow. GeoAdmin remains available as a session
fallback when that dataset cannot be used.
