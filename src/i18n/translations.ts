...
const frenchTranslations = {
  ...
  'map.layers.mobileTitle': 'Cartes et données',
  'map.layers.close': 'Fermer les cartes et données',
...
const germanTranslations: Record<TranslationKey, string> = {
  ...
  'map.layers.mobileTitle': 'Karten und Daten',
  'map.layers.close': 'Karten und Daten schliessen',
...
const italianTranslations: Record<TranslationKey, string> = {
  ...
  'map.layers.mobileTitle': 'Carte e dati',
  'map.layers.close': 'Chiudi carte e dati',
...
const englishTranslations: Record<TranslationKey, string> = {
  ...
  'map.layers.mobileTitle': 'Maps and data',
  'map.layers.close': 'Close maps and data',
